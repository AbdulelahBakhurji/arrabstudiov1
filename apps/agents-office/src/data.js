...
export const DEPT_KEYS = ['emails', 'sales', 'marketing', 'ops', 'fin', 'delivery', 'files'];
export const DEPTS = {
  emails:    { name: 'EMAILS',           short: 'EMAILS',  chip: '#4CB896', ink: '#1E9070', floor: '#DDEBE4' },
  delivery:  { name: 'DELIVERY',         short: 'DELIVERY', chip: '#6FB4D4', ink: '#2E86AB', floor: '#D9E7F0' },
  sales:     { name: 'SALES',            short: 'SALES',   chip: '#D2C078', ink: '#8A7620', floor: '#EBE4CF' },
  marketing: { name: 'MARKETING',        short: 'MARKETING', chip: '#D48484', ink: '#B05555', floor: '#EFE0DD' },
  fin:       { name: 'FINANCE',          short: 'FINANCE', chip: '#8794D8', ink: '#5B66CE', floor: '#DFE4F2' },
  ops:       { name: 'OPERATIONS',       short: 'OPERATIONS', chip: '#A88FCF', ink: '#6B4A9A', floor: '#E6DFEF' },
  files:     { name: 'FILES',            short: 'FILES',  chip: '#8E9AAB', ink: '#4A5A6A', floor: '#E2E6EC' },
  brain:     { name: 'THE BRAIN',        short: 'THE BRAIN', chip: '#B7C6B2', ink: '#4C7A57', floor: '#E0E7DC' },
};
...
export const AGENTS = [
  ...
  // FILES (1) — upload center / database floor; only one seat: Secretary
  { id: 'sec',   name: 'SECRETARY',         dept: 'files',    lead: true,  grid: [0.85, 1.35], hair: '#2a2a2a', skin: '#E8B98E' },
];
...
export const LAYOUT = {
  ...
  files:     { pos: [48, 0],    w: 22, d: 20 },   // file upload center — shelves + secretary
};
...
export const BILLBOARDS = {
  ...
  files:     [{ id: 'files',     label: 'FILES STORED',     val: 0 }],
};
...
export const WORKLINES = {
  ...
  files: [
    '▸ filing upload into office database',
    '▸ indexing documents for the secretary desk',
    '▸ retrieving file for the team',
  ],
  brain: [
